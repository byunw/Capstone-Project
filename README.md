...
# Training 
  **Hyperparameters**
  ...
  Current batch of 1-lead ecgs and their corresponding labels are loaded onto NVIDIA A100-SXM4-80GB from the ram.  Then, each 1-lead ecg in the current     batch is converted into a matrix of size 140x512.And, mean pooling is applied to each matrix of size 140x512 to produce each vector of size 512.  
